...
class _PendingTransactionsScreenState extends State<PendingTransactionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.transactionsPendingTitle),
        actions: [
          IconButton(
          ...
          : Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text(AppLocalizations.of(context)!.transactionsGroup),
                      const SizedBox(width: AppSpacing.sm),
                      ChoiceChip(
                        label: Text(
                          AppLocalizations.of(
                            context,
                          )!.transactionsGroupCategory,
                        ),
                      ...
                      return Dismissible(
                        ...
                        confirmDismiss: (direction) async {
                          if (direction == DismissDirection.startToEnd) {
                            // Confirm
                            return await controller.confirmSingle(
                              transaction.id,
                            );
                          } else {
                            // Delete
                            return await controller.deleteSingle(
                              transaction.id,
                            );
                          }
                        },
