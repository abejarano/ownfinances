...
export class BudgetsService {
  ...
  async create(userId: string, payload: BudgetCreatePayload) {
  ...
  async update(userId: string, budgetId: string, payload: BudgetUpdatePayload) {
    ...
    if (merged.startDate > merged.endDate) {
      return { error: "La fecha de fin debe ser mayor a la fecha de inicio" };
    }
